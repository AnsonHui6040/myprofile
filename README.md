...
| Main branch | `main` |
| Current hardening branch | `security-optimize-nginx` |
| Current priority | Keep the existing visual design while improving security, deployment reliability, and loading performance |
...
| `README.md` | This maintenance guide for VS Code / future editing. |
